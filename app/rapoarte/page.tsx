...
const RaportsPage = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (cancelled) return;
        setShowPage(false);
        router.replace('/login?next=/rapoarte');
      } finally {
  ...
  const handleFinancialRaports = () => {
    router.push('/rap-financiar');
  };

  const handlePurchaseRaports = () => {
    router.push('/rap-achizitii');
  };
  ...
  if (!userData && !isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-red-500">Eroare: utilizator neautentificat sau problemă la autentificare.</p>
      </div>
    );
  }
          ...
          >
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
              ...
              >
                ...
                <h2 className="text-4xl font-bold text-gray-900 mb-4">Rapoarte</h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Bună ziua, {userData?.username}! Accesează și gestionează rapoartele tale
                </p>
              </motion.div>

              {/* Raports Section with aligned buttons */}
              <div className="grid md:grid-cols-2 gap-8 mb-16">
                ...
                >
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Rapoarte Financiare</h3>
                    <p className="text-gray-600 mb-8 leading-relaxed">
                      Accesează rapoartele financiare, bilanțurile și alte rapoarte contabile importante
                    </p>
                  </div>
                  <button
                    onClick={handleFinancialRaports}
                  ...
                  >
                    ...
                    <span>Vezi Rapoarte Financiare</span>
                  </button>
                </motion.div>
                ...
                >
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Rapoarte Achiziții</h3>
                    <p className="text-gray-600 mb-8 leading-relaxed">
                      Consultă rapoartele de achiziții, contractele și procesele de procurement
                    </p>
                  </div>
                  <button
                    onClick={handlePurchaseRaports}
                  ...
                  >
                    ...
                    <span>Vezi Rapoarte Achiziții</span>
                  </button>
                </motion.div>
              </div>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-gray-600 leading-relaxed max-w-2xl mx-auto">
                    Toate rapoartele sunt confidențiale și destinate doar utilizatorilor autorizați.
